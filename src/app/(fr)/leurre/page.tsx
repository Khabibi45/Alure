...
export const metadata: Metadata = {
  ...
  description: `Le leurre Alure : articulé deux sections, pensé pour les carnassiers. ${formatEuros(PRODUCT.pricing.soloCents)} le leurre, ou la collection des ${PRODUCT.colorways.length} coloris pour ${formatEuros(OFFERS.collection.amountCents)} avec le coloris collector offert. Livraison incluse (${PRODUCT.deliveryDelay}), paiement carte ou PayPal, rétractation 14 jours.`,
}
 ...
 */
export default function LeurrePage() {
  return (
    ...
    <main className="mx-auto max-w-5xl px-5 py-8 pb-28 md:py-16 md:pb-16">
      ...
      <ColorwayProvider>
        <div className="grid gap-8 md:grid-cols-2 md:gap-12">
          ...
          {/* Panneau d'achat — desktop : colonne collante (charte §8.9). */}
          <section aria-label="Acheter" className="min-w-0 md:sticky md:top-24 md:self-start">
            ...
            {/* Réassurance (§8.10) — trois faits, séparateurs 1px sur mobile. */}
            <ul className="mt-8">
              {[
